  ...
  return (
    <div className="flex min-h-[100dvh] flex-col">
      <section className="w-full py-12 md:py-24 lg:py-32">
        <div className="container grid gap-6 px-4 md:px-6 lg:grid-cols-2 lg:gap-12 xl:grid-cols-[1fr_600px]">
          ...
          <Image
            ...
            height="550"
            alt="Hero"
            className="rounded-xl mx-auto aspect-square overflow-hidden object-cover sm:w-full lg:order-last"
          />
        </div>
      </section>
      ...
      <footer className="flex w-full shrink-0 flex-col items-center gap-2 border-t px-4 py-6 sm:flex-row md:px-6">
        <div className="flex flex-col gap-4 text-xs text-muted-foreground sm:flex-row sm:gap-6">
          <Link
            href="#"
        ...
        <p className="text-xs text-muted-foreground sm:ml-auto">
          &copy; 2025 CCTV Automation. All rights reserved.
        </p>
      </footer>
    </div>
  );
